...
| glibc | POSIX threading, networking, file I/O | Built (Debian sid: glibc 2.41 on riscv64) | See reports/glibc.md | Released | None Galera-specific |
...
| Security | Track and test OpenSSL `Zkn` constant-time AES fix on target hardware; see reports/openssl.md | 0 (tracked in OpenSSL) | OpenSSL project | High (for production deployments) |
