...
| Kubernetes (k8s.io/api, k8s.io/client-go) | Platform runtime | Pure Go; compilable | No riscv64 CI | No official riscv64 images | Hard blocker. Issue #132836 open (proposal for Tier 3 riscv64). No KEP yet as of 2026-08. See [reports/kubernetes.md](../reports/kubernetes.md). |
...
The operator binary itself requires minimal work (Dockerfile base image swap, platform matrix addition). The dominant effort is in the managed component images. MySQL/PXC riscv64 enablement is tracked separately in [reports/mysql.md](../reports/mysql.md) and is a prerequisite for this operator to be useful. Kubernetes riscv64 enablement is tracked in [reports/kubernetes.md](../reports/kubernetes.md) and is also a prerequisite.
