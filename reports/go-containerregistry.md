...
| [go.opentelemetry.io/otel](https://github.com/open-telemetry/opentelemetry-go) v1.41.0 | Tracing/metrics instrumentation | Yes (pure Go) | No riscv64 CI | N/A | None; see `reports/opentelemetry.md` |
...
Cross-references to other scope.yml reports: Go (`reports/go.md`), OpenTelemetry (`reports/opentelemetry.md`), containerd (`reports/containerd.md`), Docker (`reports/docker.md`).
