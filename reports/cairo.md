...
| FreeType | Font rasterization; required | Installed (2.14.3+dfsg-2, Debian sid) | Unknown | Released | None. See [reports/freetype.md](../reports/freetype.md) |
| fontconfig | Font configuration and discovery; required | Installed (2.17.1-5, Debian sid) | Unknown | Released | None known |
| libpng | PNG surface I/O; required | Installed (1.6.58-1, Debian sid) | Unknown | Released | None. See [reports/libpng.md](../reports/libpng.md) |
| zlib | Compression for PNG and PDF backends; required | Installed (1.3.dfsg+really1.3.2-3, Debian sid) | Unknown | Released | None. See [reports/zlib.md](../reports/zlib.md) |
...
| HarfBuzz | Used via FreeType for OpenType shaping (indirect dep via font backends) | Unknown from Debian | Unknown | Unknown | See [reports/harfbuzz.md](../reports/harfbuzz.md) |
