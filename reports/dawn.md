...
| SwiftShader (CPU Vulkan) | Yes, LLVM JIT working | Yes, LLVM JIT working | Blocked -- CMake misdetects arch; LLVM 10 default breaks JIT (see `reports/swiftshader.md`) |
