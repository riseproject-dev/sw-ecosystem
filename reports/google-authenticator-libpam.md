...
| glibc | C runtime; `dlopen`, `explicit_bzero`, `setfsuid` | Implicit | OK -- riscv64 supported since glibc 2.27 | Tested by glibc upstream CI | Yes, all major distros | See [reports/glibc.md] |
