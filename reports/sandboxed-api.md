...
|---|---|---|---|---|---|
| [abseil-cpp](https://github.com/abseil/abseil-cpp) | Core utilities, string, hash, CRC32C, logging | Builds (minor warnings fixed upstream) | Functional; no arch-specific failures known | Source-only; no per-arch artifacts | PR #1986 (CRC32C HW accel, open Dec 2025, awaiting hardware verification); see `reports/abseil-cpp.md` |
...
| [RE2](https://github.com/google/re2) | Regex in sandboxed library policy evaluation | Builds cleanly; zero riscv64 issues ever filed | No riscv64 CI; assumed functional (pure C++, no arch asm) | Source-only, N/A | None; see `reports/re2.md` |
| [zlib](https://github.com/madler/zlib) | Compression in examples; optional | Builds; zero riscv64 issues filed | No riscv64 CI | Source-only, N/A | None; see `reports/zlib.md` |
| [libseccomp](https://github.com/seccomp/libseccomp) | Kernel syscall filtering (core sandbox mechanism) | Builds; riscv64 support added in v2.5.0 (2020) | Functional; all riscv64 issues closed | Distributed via distros | None currently open; see `reports/libseccomp.md` |
...
| [libunwind](https://github.com/libunwind/libunwind) | Stack unwinding in crash handlers, ptrace support | Builds; Linux riscv64 listed as supported in README | Partial: C++ exception support on riscv64 deliberately disabled (PR #1032 abandoned); CMake build unverified (issue #765 open) | Source-only, N/A | #765 (CMake support for RISCV, open); C++ exception handling unresolved; see `reports/libunwind.md` |
| [GoogleTest](https://github.com/google/googletest) | Unit testing framework | Builds | Bug: `GetThreadCountTest.ReturnsCorrectValue` fails on riscv64 (#3756, open since Feb 2022, assigned but unfixed) | Source-only, N/A | #3756 (open, `GetThreadCount()` returns 0 on riscv64); see `reports/googletest.md` |
| [Google Benchmark](https://github.com/google/benchmark) | Microbenchmarks (test-only) | Builds; riscv64 cycleclock fixed (#1802 merged Jun 2024; #1549 merged Feb 2023) | Functional; cycleclock and CPU frequency estimation fixed | Source-only, N/A | None currently open; see `reports/benchmark.md` |
...
- [abseil-cpp RISC-V report](reports/abseil-cpp.md)
- [googletest RISC-V report](reports/googletest.md)
- [google benchmark RISC-V report](reports/benchmark.md)
- [RE2 RISC-V report](reports/re2.md)
- [zlib RISC-V report](reports/zlib.md)
- [libseccomp RISC-V report](reports/libseccomp.md)
- [libunwind RISC-V report](reports/libunwind.md)