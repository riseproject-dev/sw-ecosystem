...
| glibc (libcrypt) | Required. `AC_CHECK_LIB(crypt)` for legacy password hashing. | glibc has full riscv64 support (tier 1 since 2018). | glibc riscv64 CI is upstream. | Ships in all riscv64 Linux distributions. | None. See `reports/glibc.md`. |
