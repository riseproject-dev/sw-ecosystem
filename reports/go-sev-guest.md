...
|---|---|---|---|---|---|
| Go stdlib (1.19+) | Runtime, crypto/ecdsa, encoding/binary | Yes - linux/riscv64 Tier 1 since Go 1.17 | Yes | Yes | See reports/go.md |
...
| google.golang.org/protobuf v1.33.0 | Proto serialization of attestation reports | Yes - pure Go | Yes | Yes | See reports/protocol-buffers.md |
