...
|---|---|---|---|---|---|---|
| PostgreSQL | Host database server | 14+ (12-18 per docs) | Built successfully (postgresql-17 17.10, trixie/sid) | Unverified | Released in trixie/sid | See [reports/postgresql.md](postgresql.md) |
