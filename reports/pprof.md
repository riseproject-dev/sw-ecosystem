...
|------------|------|--------------|--------------|-----------------|-----------|
| Go toolchain (>= 1.25) | Compiles and runs pprof; provides debug/elf for ELF parsing | Supported (linux/riscv64 secondary port since Go 1.14; linux/riscv64 first-class since Go 1.21) | Passes on upstream RISE/Go builders; freebsd/riscv64 broken (golang/go#76475) but linux/riscv64 unaffected | Go 1.24+ ships linux/riscv64 binaries at go.dev/dl | Active; see reports/go.md |
