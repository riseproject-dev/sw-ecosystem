...
- **Linux Kernel & GNU Toolchain ([glibc](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/glibc.md), [GCC](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/gdb.md), [GDB](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/gdb.md), [linux-perf](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/linux-perf.md), [eBPF](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/ebpf.md))**:
...
- **LLVM Compiler Infrastructure & Clang ([LLDB](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/lldb.md))**:
  - `riscv64` is a first-class compilation target with complete RVV 1.0 vector intrinsic and auto-vectorization support.
- **Go / Golang ([go](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/go.md))**:
...
- **OpenJDK / Java ([openjdk](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/openjdk.md))**:
  - JEP 422 ("Linux/RISC-V Port") delivered mainline into OpenJDK 19+. HotSpot JIT compiler is fully supported and maintained.
- **llama.cpp ([llama-cpp](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/llama-cpp.md))**:
...
- **OpenSSL ([openssl](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/openssl.md))**:
  - Full upstream integration including RVV-accelerated cryptographic primitives (`Zkn`/`Zks`).
- **Container Infrastructure ([containerd](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/containerd.md), [runc](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/runc.md), [Docker](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/docker.md), [Kubernetes](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/kubernetes.md))**:
  - High maintainer receptivity with full multi-arch container image support (`linux/riscv64`).
- **FFmpeg ([ffmpeg](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/ffmpeg.md)) & dav1d ([dav1d](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/dav1d.md))**:
...
- **vLLM ([vllm](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/vllm.md))**:
...
- **NumPy ([numpy](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/numpy.md))**:
  - Merged native RISC-V CI (PR #31488, May 2026); an official `riscv64` PyPI wheel is targeted for release 2.6.0 (Q3 2026).
- **LangChain ([langchain](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/langchain.md))**:
...
- **oneDNN ([onednn](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/onednn.md)) & OpenBLAS ([openblas](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/openblas.md))**:
...
1. **PyTorch (`pytorch/pytorch`) ([pytorch](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/pytorch.md))**:
...
2. **google/sentencepiece ([vllm report](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/vllm.md#9-dependencies))**:
...
3. **openai/tiktoken ([vllm report](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/vllm.md#9-dependencies))**:
...
4. **numba / llvmlite ([numba](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/numba.md))**:
...
5. **pydantic / pydantic-core ([langchain report](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/langchain.md#9-dependencies))**:
   - **Maintainer Stance**: Closed the `riscv64` CI PR ([#1901](https://github.com/pydantic/pydantic-core/pull/1901)) without merging.
6. **protocolbuffers / protobuf ([pytorch report](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/pytorch.md#9-dependencies))**:
...
7. **XNNPACK (`google/XNNPACK`) ([xnnpack](file:///Users/gregsterling/repos/git/sw-ecosystem/project-reports/xnnpack.md))**:
