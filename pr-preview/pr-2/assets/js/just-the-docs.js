...
function initSearch() {
  ...
  request.open('GET', '/sw-ecosystem/pr-preview/pr-2/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/sw-ecosystem/pr-preview/pr-2/assets/css/just-the-docs-' + theme + '.css');
}
