...
- `project-reports/gwpsan.md` - Google's GWP-ASan successor; riscv64 not yet in its supported arch list
- `project-reports/honggfuzz.md` - fuzzing engine; uses sanitizer runtimes
- `project-reports/fuzztest.md` - structured fuzzing; depends on ASan/UBSan
- `project-reports/atheris.md` - Python fuzzer; depends on libffi and ASan
- `project-reports/clusterfuzz.md` - fuzzing infrastructure; orchestrates sanitizer builds
- `project-reports/oss-fuzz.md` - continuous fuzzing; ASan/MSan/UBSan required for harnesses
- `project-reports/lldb.md` - debugger; uses libunwind, shares compiler-rt
- `project-reports/valgrind.md` - independent memory checker; parallel tool, not a dependency
