...
| Dependencies | OpenSSL AES/GHASH constant-time fix on riscv64 (#31080/#31082) | See `project-reports/openssl.md` | OpenSSL contributor | High (security) |
| Dependencies | zstd 4-way Huffman decode loop on riscv64 (#4622) | See `project-reports/zstd.md` | Facebook/zstd contributor | Medium (performance) |
