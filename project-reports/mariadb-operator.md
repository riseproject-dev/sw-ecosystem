...
{% include dependency-graph.html slug="dependencies" subset="mariadb-operator" %}
...
- Kubernetes (k8s.io/api, k8s.io/client-go): see `project-reports/kubernetes.md`
- Prometheus (github.com/prometheus/client_golang): see `project-reports/prometheus.md`
- MariaDB (the database the operator manages): see `project-reports/mariadb.md`
- MariaDB Connector/C: see `project-reports/mariadb-connector-c.md`
