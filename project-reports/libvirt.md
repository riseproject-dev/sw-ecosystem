...
| libxml-2.0 (>= 2.9.1) | Parses all domain/network/pool XML | Installed (Debian sid 2.15.3+dfsg-1) | Unknown | Debian sid | None known. See `project-reports/libxml2.md` |
| QEMU (runtime, not build dep) | Primary hypervisor backend | Installed (Debian sid 1:11.0.1+ds-1) | Unknown (riscv64 host) | Debian sid | None for host-side libvirt use. See `project-reports/qemu.md` |
| libcurl (>= 7.19.1, optional) | Storage driver remote access, migration URLs | Installed (Debian sid 8.21.0~rc3-1) | Unknown | Debian sid | None known. See `project-reports/libcurl.md` |
...
| readline (optional) | virsh interactive line editing | Installed (Debian sid 8.3-4) | Unknown | Debian sid | None. See `project-reports/readline.md` |
| libcap-ng (optional) | Capability management for daemon privilege drop | Installed (Debian sid 0.9.3-1) | Unknown | Debian sid | None. See `project-reports/libcap.md` |
...
| Python 3 (build tool) | Code generation scripts | Available (Debian sid) | N/A | Available | None. See `project-reports/python.md` |
