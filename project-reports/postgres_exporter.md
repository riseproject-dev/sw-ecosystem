...
| PostgreSQL server (runtime, not in go.mod) | Database being monitored | Partial - PostgreSQL 17+ builds on riscv64; no official Postgres riscv64 CI | Partial | No official riscv64 binaries | See `project-reports/postgresql.md` |
