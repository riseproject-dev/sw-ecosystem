...
{% include dependency-graph.html slug="dependencies" subset="pgbouncer" %}
...
| glibc (implicit) | C runtime | Supported, Tier 1 | Full riscv64 CI | All major distros | See `project-reports/glibc.md` |
...
Pure C, no architecture-specific code, no known riscv64 issues. libevent 2.1.13-stable and 2.2.2-alpha are available in Debian/Ubuntu riscv64. See `project-reports/libevent.md`.
