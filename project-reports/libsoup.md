...
**libnghttp2:** Pure C, no SIMD. Available in Debian sid (v1.69.0-1). No riscv64-specific issues identified. See `project-reports/nghttp2.md` for details.

**SQLite:** Available in Debian sid (v3.53.2-1). See `project-reports/sqlite.md` (25,043 bytes).

**glibc** (runtime, not a direct libsoup dependency): See `project-reports/glibc.md` (31,546 bytes).
