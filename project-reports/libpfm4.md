...
| glibc / libc6 | Standard C runtime | Yes -- Debian/Ubuntu riscv64 v2.39+ | Tested | Released | No blockers. See `./project-reports/glibc.md` |
...
| Python 3 / python3-dev | Optional -- Python bindings in `python/` subdirectory | Yes -- Debian sid riscv64 v3.13.9-3+b1 | Functional | Released | Bindings build; no HW event support on riscv64. See `./project-reports/python.md` |
