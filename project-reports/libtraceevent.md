...
|---|---|---|---|---|---|
| glibc / musl | Runtime: only mandatory runtime dependency; libtraceevent.so.1 links only to libc | Pass | N/A (no arch-specific code path) | Released, all major distros | See `project-reports/glibc.md` |
