...
{% include dependency-graph.html slug="dependencies" subset="opensk" %}
...
| openssl v0.10.80 (build-dep only) | UUID generation in build script | yes (build host only) | N/A | crates.io | 82 open riscv64 issues in openssl/openssl but none block this build-dep usage; see project-reports/openssl.md |
