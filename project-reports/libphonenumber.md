...
{% include dependency-graph.html slug="dependencies" subset="libphonenumber" %}
...
| GoogleTest | Test-only dependency. Not linked into the shipped library. | Builds | Partial | N/A (test only) | Issue #3756 (open, 2022, stale): `GetThreadCountTest.ReturnsCorrectValue` fails on riscv64. Does not block library functionality. See `project-reports/googletest.md`. |
...
- [Abseil-cpp riscv64 status (internal cross-reference)](../project-reports/abseil-cpp.md)
- [Protocol Buffers riscv64 status (internal cross-reference)](../project-reports/protocol-buffers.md)
- [ICU riscv64 status (internal cross-reference)](../project-reports/icu.md)
- [GoogleTest riscv64 status (internal cross-reference)](../project-reports/googletest.md)