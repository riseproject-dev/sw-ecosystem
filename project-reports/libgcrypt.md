...
| pthreads (glibc libpthread) | Threading (pthread_create, pthread_mutex) | PASS (glibc 2.27+ has riscv64) | Passes as part of glibc test suite | All current riscv64 distros | See `project-reports/glibc.md` |
...
**In-scope cross-reference:** glibc (pthreads + kernel header integration) -- see ![project-reports/glibc.md](glibc.md).
